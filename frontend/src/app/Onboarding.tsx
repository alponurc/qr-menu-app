...
//   const {onboarding: onboardingData, onboardingLoading} = hooks.useGetOnboarding();

//   const isDataReady = onboardingData && Array.isArray(onboardingData) && onboardingData.length > 0;

//   const renderCarousel = () => {
//     if (!isDataReady || onboardingLoading) return null;
...
//         }}
//       >
//         <Swiper onSlideChange={(swiper) => setCurrentSlideIndex(swiper.activeIndex)}>
//           {onboardingData.map((item) => (
...
//               height: currentSlideIndex === index ? 20 : 8,
//               borderRadius: '4px',
//               backgroundColor: currentSlideIndex === index ? '#00B0B9' : '#ACE3E6',
//             }}
//           />
//         ))}
//       </section>
...
//             {currentItem.title2}
//           </h1>
//           <p className='t16' style={{marginTop: '14px', color: '#B4B4C6', textAlign: 'center'}}>
//             {currentItem.description1} <br />
//             {currentItem.description2}
//           </p>
//         </div>
